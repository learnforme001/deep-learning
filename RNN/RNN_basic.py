...
def RNN_head(use_random_iter=False):
    """
    Docstring for RNN_head
    
    :param use_random_iter: Description
    """
    num_hiddens = 512
    net = RNNModelScratch(len(vocab), num_hiddens, TryGPU.try_gpu(), get_params,
                            init_rnn_state, rnn)
    num_epochs, lr = 500, 1
