...
from attention import nadaraya_watson_main, bahdanau_main, self_attention_main, transformer_main
from RNN import sequence_model_main, RNN_head, RNN_torch, gru_torch, gru_head, LSTM_torch, LSTM_head, Deep_RNN_torch, Seq2Seq_main
